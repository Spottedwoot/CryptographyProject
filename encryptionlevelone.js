...
document.getElementById("question").innerHTML= "("+small_primes[random1].toString() + "-1)*(" + small_primes[random2].toString()+ "-1)";
var answer = (small_primes[random1]-1)*(small_primes[random2]-1);
